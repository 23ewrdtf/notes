...
One "public" subnet in VPC with 0.0.0.0/0 route to the IGW gateway

Above "public" subnet with a NAT GW assigned to it.

One "private" subnet in the same VPC with 0.0.0.0/0 route to above NAT gateway
