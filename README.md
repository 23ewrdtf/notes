...
Save
Restart NTP service: svcadm restart svc:/network/ntp
Check if the service is up: svcs | grep ntp
Check syslog:  cat /var/adm/messages | grep ntp
See whats NTP is doing: ntpq -p
