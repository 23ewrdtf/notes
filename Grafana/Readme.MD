...
#### Create a config map to include custom dashboards. 
#### Those are build into the configmap file. 
...
`helm upgrade --install kube-prometheus -f values.yaml --namespace monitoring coreos/kube-prometheus --recreate-pods`
